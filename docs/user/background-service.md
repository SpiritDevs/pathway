# Running Pathway in the Background

On a Linux host, Pathway can run as a background service for your user. It starts when the machine
...
The systemd unit runs a small stable launcher. Exact Pathway versions are installed separately, so
