...
- Top profile dropdown → Provider usage: account/environment summaries load and hide Spark quotas. Provider Settings retains the Spark quotas and labels the reserve quota Luna. Luna is hidden from thread details and the profile menu.
