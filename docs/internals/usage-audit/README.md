...
- Top profile dropdown → Provider usage: account/environment summaries load and hide unauthenticated Claude and Spark quotas. Provider Settings retains the Spark quotas and labels the reserve quota Lunar Reserve. Lunar Reserve is hidden from thread details and the profile menu.
