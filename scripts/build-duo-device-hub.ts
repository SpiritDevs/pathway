...
const output = NodePath.resolve(process.argv[2] ?? "/tmp/pathway-duo-build");
// oxlint-disable-next-line pathway/no-global-process-runtime -- Standalone build entry point, not a server service.
