  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Pathway prerelease is available for nightly testers."
          : "A new Pathway latest release is available.",
...
).pipe(Command.withDescription("Post a Pathway release announcement to Discord."));
