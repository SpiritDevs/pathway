...
describe("brand-assets", () => {
  ...
  it("generates every icon family from the canonical Pathway icon", () => {
    expect(BRAND_ASSET_PATHS.pathwayIconSourcePng).toBe("assets/prod/pathway-macos-1024.png");
    ...
    expect(BRAND_ASSET_PATHS.productionMacIconPng).toMatch(/^assets\/prod\/pathway-/);
  });
});
