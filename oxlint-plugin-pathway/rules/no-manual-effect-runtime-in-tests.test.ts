...
const rule = createOxlintRuleHarness("pathway/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("pathway/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("pathway/no-manual-effect-runtime-in-tests");
