...
export default defineConfig({
  ...
  lint: {
    ...
    jsPlugins: ["./oxlint-plugin-pathway/index.ts"],
    categories: {
      correctness: "warn",
      suspicious: "warn",
      perf: "warn",
    ...
    rules: {
      ...
      "pathway/no-global-process-runtime": "error",
      "pathway/no-inline-schema-compile": "warn",
      "pathway/no-manual-effect-runtime-in-tests": "error",
      "pathway/namespace-node-imports": "error",
    },
    options: {
