...
export const RPC_REQUIRED_SCOPES = {
  ...
  [ORCHESTRATION_V2_WS_METHODS.subscribeWorkspaceCleanup]: AuthOrchestrationReadScope,
  [ORCHESTRATION_V2_WS_METHODS.retryWorkspaceCleanup]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.serverGetComposerCatalog]: AuthOrchestrationReadScope,
  [WS_METHODS.serverRefreshProviders]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverStartProviderAuthentication]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverCompleteProviderAuthentication]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverCancelProviderAuthentication]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.storageSnapshot]: AuthOrchestrationReadScope,
  [WS_METHODS.storagePreview]: AuthOrchestrationReadScope,
  [WS_METHODS.storageSetPolicy]: AuthOrchestrationOperateScope,
  [WS_METHODS.storageSetKeep]: AuthOrchestrationOperateScope,
  [WS_METHODS.storageStart]: AuthOrchestrationOperateScope,
  [WS_METHODS.storageCancel]: AuthOrchestrationOperateScope,
  [WS_METHODS.storageRecreate]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.usageRecoveryGet]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.cloudIssueImportPreview]: AuthOrchestrationReadScope,
  [WS_METHODS.cloudIssueImportExecute]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.sourceControlListRepositoryOwners]: AuthOrchestrationOperateScope,
  [WS_METHODS.projectsListEntries]: AuthOrchestrationReadScope,
  [WS_METHODS.projectsReadFile]: AuthOrchestrationReadScope,
  [WS_METHODS.projectsSearchContents]: AuthOrchestrationReadScope,
  [WS_METHODS.projectsSearchEntries]: AuthOrchestrationReadScope,
  [WS_METHODS.projectsInspectDirectory]: AuthOrchestrationReadScope,
  ...
  [ISSUES_WS_METHODS.getIssueLinksForThread]: AuthOrchestrationReadScope,
