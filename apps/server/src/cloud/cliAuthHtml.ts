...
export function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __PATHWAY_BUILD_CHANNEL__ === "undefined" ? "dev" : __PATHWAY_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "Pathway (Dev)",
  nightly: "Pathway (Nightly)",
  latest: "Pathway",
...
<html lang="en">
  <head>
    ...
    <title>Pathway Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up Pathway Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
