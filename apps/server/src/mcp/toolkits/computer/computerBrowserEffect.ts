/**
 * The audit effect a `computer_browser_*` driver reply proves, and whether a
 * typed field's value was read back.
 *
 * @module mcp/toolkits/computer/computerBrowserEffect
 */
import type { ComputerAuditEffect, ComputerBrowserToolName } from "@spiritdevs/contracts";
