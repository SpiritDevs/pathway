 ...
 * agent-device daemon in HTTP mode under a Pathway-owned state directory. Both are
 ...
 *
 * The hub runs in its standalone mode (origin root). The Pathway proxy strips its
...
} from "@spiritdevs/shared/nodeRuntime";
