...
import { type GrokSettings, ProviderDriverKind } from "@spiritdevs/contracts";
...
const Pathway_CODE_OAUTH_REFERRER = "pathway";
...
export function buildGrokAcpSpawnInput(
  ...
  return {
    ...
    env: {
      ...environment,
      [GROK_OAUTH2_REFERRER_ENV]: Pathway_CODE_OAUTH_REFERRER,
    },
  };
}
