...
>()("@spiritdevs/pathway/provider/providerMaintenanceRunner") {}
            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but Pathway could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but Pathway still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
