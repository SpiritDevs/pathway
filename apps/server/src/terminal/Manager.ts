...
>()("@spiritdevs/pathway/terminal/Manager/TerminalManager") {}
...
function shouldExcludeTerminalEnvKey(key: string): boolean {
  ...
  if (normalizedKey.startsWith("PATHWAY_")) {
    return true;
  }
...
// temporary mount (e.g. /tmp/.mount_Pathway-XXXX/usr/bin, the bundled glib schemas,
