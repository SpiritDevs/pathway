...
import { SourceControlProviderError, type ChangeRequest } from "@spiritdevs/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set PATHWAY_BITBUCKET_EMAIL and PATHWAY_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
