 ...
 */
import { IssueId, IssueRelation, IssueRelationEdge, IssueRelationId } from "@spiritdevs/contracts";
...
>()("@spiritdevs/pathway/persistence/Services/IssueRelations/IssueRelationRepository") {}
