 ...
 */
import type { UsageProviderKind, UsageTokenTotals } from "@spiritdevs/contracts";
 ...
 *
 * Pathway writes one record per assistant *content block*, and every one of
...
export function parseCodexLine(
  ...
  const signature = JSON.stringify(cumulative ?? lastRecord);
