...
import { T3_PROJECT_FILE_NAME, type T3ProjectFile } from "@spiritdevs/contracts";
import { T3ProjectFileFromJson } from "@spiritdevs/shared/t3ProjectFile";
...
>()("@spiritdevs/pathway/project/T3ProjectFileLoader") {}
