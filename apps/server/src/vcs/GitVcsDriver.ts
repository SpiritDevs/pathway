...
>()("@spiritdevs/pathway/vcs/GitVcsDriver") {}
  ...
  const checkpoints: VcsDriver.VcsCheckpointOps = {
    captureCheckpoint: Effect.fn("GitVcsDriver.checkpoints.captureCheckpoint")(function* (input) {
      ...
      const commitEnv: NodeJS.ProcessEnv = {
        ...
        GIT_AUTHOR_NAME: "Pathway",
        GIT_AUTHOR_EMAIL: "pathway@users.noreply.github.com",
        GIT_COMMITTER_NAME: "Pathway",
        GIT_COMMITTER_EMAIL: "pathway@users.noreply.github.com",
      };
