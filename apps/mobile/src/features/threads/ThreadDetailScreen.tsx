...
export const ThreadDetailScreen = memo(function ThreadDetailScreen(props: ThreadDetailScreenProps) {
  ...
  useEffect(() => {
    ...
    const latestRunCompletedAtMs = props.selectedThread.latestRun?.completedAt
      ? Date.parse(props.selectedThread.latestRun.completedAt)
      : NaN;
    const hasUnseenCompletion =
      !Number.isNaN(latestRunCompletedAtMs) &&
      (Number.isNaN(lastVisitedAtMs) || latestRunCompletedAtMs > lastVisitedAtMs);
    ...
    props.environmentId,
    props.selectedThread.latestRun?.completedAt,
    selectedThreadId,
    selectedThreadKey,
