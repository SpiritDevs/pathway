...
import { PathwayKeyboardCommands } from "../../native/PathwayKeyboardCommands";
import {
...
export function HardwareKeyboardCommandProvider({
  ...
  return (
    <PathwayKeyboardCommands enabledCommands={enabledCommands} onCommand={onCommand}>
      {children}
    </PathwayKeyboardCommands>
  );
}
