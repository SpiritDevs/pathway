...
import { PATHWAY_BRAND_MARK_SOURCE } from "./brandAssets";
    ...
    <View className="flex-row items-center gap-3">
      ...
      <View className="gap-1">
        <View className="flex-row items-center gap-2">
          <Text className="text-lg font-pathway-bold tracking-[-0.4px] text-foreground">
            Pathway
          </Text>
          <View className="rounded-full bg-subtle px-2 py-1">
            <Text className="text-3xs font-pathway-bold tracking-[1.1px] uppercase text-foreground-muted">
              {stageLabel}
            </Text>
          </View>
        </View>
