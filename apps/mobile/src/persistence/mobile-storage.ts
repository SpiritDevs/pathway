...
const CONNECTIONS_KEY = "pathway.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "pathway.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "pathway.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "pathway.recent-thread-shortcuts";
...
>()("@spiritdevs/mobile/persistence/MobileStorage") {}
