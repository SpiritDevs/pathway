...
import PathwayMarkdownTextRunNativeComponent from "./PathwayMarkdownTextRunNativeComponent";
import PathwayMarkdownTextNativeComponent from "./PathwayMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({ style, children, ...rest }: MarkdownTextPrimitiveProps) {
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <PathwayMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <PathwayMarkdownTextNativeComponent
          {...textDefaults}
          {...rest}
