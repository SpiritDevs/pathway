...
const customSprite = webIconSource.match(/const Pathway_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error(
    "Could not read the Pathway Pierre icon sprite from apps/web/src/pierre-icons.ts",
  );
}
...
const customIcons = {
  agents: "pathway-file-icon-agents",
  claude: "pathway-file-icon-claude",
  package: "pathway-file-icon-package-json",
  pnpm: "pathway-file-icon-pnpm",
  readme: "pathway-file-icon-readme",
  tsconfig: "pathway-file-icon-tsconfig",
};
