...
private final class ComposerTextView: UITextView {
  private static let pastedImageDirectoryName = "pathway-composer-paste"
...
public final class PathwayComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate {
