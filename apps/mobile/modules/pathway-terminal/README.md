# Pathway Mobile Terminal Native Module
...
fork, with Pathway's iOS 16 compatibility patch applied. `PathwayTerminalView` owns a `libghostty` surface and
...
```bash
apps/mobile/modules/pathway-terminal/scripts/build-libghostty-ios16.sh
```
...
```bash
apps/mobile/modules/pathway-terminal/scripts/build-libghostty-android.sh
```
