...
Pod::Spec.new do |s|
  s.name = 'PathwayTerminalNative'
  s.version = package['version']
  s.summary = 'Native terminal surface for Pathway mobile.'
  s.description = 'Native terminal surface bridge used by the Pathway React Native app.'
