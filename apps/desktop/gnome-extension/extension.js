...
const NAME = "org.gnome.Shell.Extensions.PathwaySnapShot";
const PATH = "/org/gnome/Shell/Extensions/PathwaySnapShot";
...
function takeSnapshot(animate) {
  ...
  if (animate && St.Settings.get().enable_animations) {
    try {
      ...
      console.warn(`Pathway capture preview unavailable: ${error.message}`);
    }
  }
...
export default class PathwaySnapShotExtension extends Extension {
  enable() {
