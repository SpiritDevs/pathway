...
export const PREVIEW_ADOPT_POPUP_CHANNEL = "desktop:preview-adopt-popup";
export const PREVIEW_DISCARD_POPUP_CHANNEL = "desktop:preview-discard-popup";
export const PREVIEW_PRESENT_NATIVE_TAB_CHANNEL = "desktop:preview-present-native-tab";
export const PREVIEW_POPUP_REQUEST_CHANNEL = "desktop:preview-popup-request";
export const PREVIEW_POPUP_CLOSED_CHANNEL = "desktop:preview-popup-closed";
...
export const PREVIEW_RECORDING_READ_CHANNEL = "desktop:preview-recording-read";
