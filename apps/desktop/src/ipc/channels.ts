...
export const SET_SNAP_SHOT_ACCOUNT_CHANNEL = "desktop:set-snap-shot-account";
export const CAPTURE_SNAP_SHOT_CHANNEL = "desktop:capture-snap-shot";
export const EXPORT_SNAP_SHOT_CHANNEL = "desktop:export-snap-shot";
