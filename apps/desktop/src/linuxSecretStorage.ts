...
function getGnomeKeyringRemediationMessage(): string {
  return "Pathway could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart Pathway.";
}

function getKWalletRemediationMessage(): string {
  return "Pathway could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart Pathway.";
}
