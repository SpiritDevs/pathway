...
import { EnvironmentId, type PersistedSavedEnvironmentRecord } from "@spiritdevs/contracts";
...
function makeLayer(
  ...
  const environmentLayer = DesktopEnvironment.layer({
    ...
    Layer.provide(
      Layer.mergeAll(NodeServices.layer, DesktopConfig.layerTest({ PATHWAY_HOME: baseDir })),
    ),
  );
