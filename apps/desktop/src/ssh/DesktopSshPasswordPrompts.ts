import type { DesktopSshPasswordPromptRequest } from "@spiritdevs/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@spiritdevs/contracts";
import type { SshPasswordRequest } from "@spiritdevs/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `Pathway window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@spiritdevs/desktop/ssh/DesktopSshPasswordPrompts") {}
