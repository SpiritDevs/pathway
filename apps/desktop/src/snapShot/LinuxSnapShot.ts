...
const EXTENSION = "org.gnome.Shell.Extensions.PathwaySnapShot";
const EXTENSION_PATH = "/org/gnome/Shell/Extensions/PathwaySnapShot";
...
export class LinuxCaptureConnection {
  ...
  async captureExtension(appId: string, options?: FeedbackOptions): Promise<LinuxWindowSnapshot> {
    ...
    if (result !== RequestNameReply.PRIMARY_OWNER) {
      throw new Error("Another Pathway instance is capturing a window. Try again.");
    }
