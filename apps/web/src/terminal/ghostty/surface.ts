...
export class GhosttyTerminalSurface {
  ...
  static async create(
    ...
    canvas.className = "pathway-ghostty-canvas";
    canvas.style.cssText = "display:block;width:100%;height:100%;";
    canvas.setAttribute("aria-hidden", "true");

    const input = document.createElement("textarea");
    input.className = "pathway-ghostty-input";
    ...
    scrollbar.className = "pathway-ghostty-scrollbar";
    ...
    scrollbarThumb.className = "pathway-ghostty-scrollbar-thumb";
