import { EDITORS, EditorId, EnvironmentId } from "@spiritdevs/contracts";
import {
...
const LAST_EDITOR_KEY = "pathway:last-editor";
...
export function resolveAndPersistPreferredEditor(
  ...
  const editor =
    EDITORS.find(
      (editor) =>
        editor.id !== "terminal" && editor.id !== "ghostty" && availableEditorIds.has(editor.id),
    )?.id ?? null;
