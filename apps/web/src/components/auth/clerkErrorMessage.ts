 ...
 * back to the caller's message. Keep codes here — both the sign-in and
 * registration forms read from this table so the error voice stays uniform.
 */
const CLERK_ERROR_COPY: Record<string, string> = {
  ...
  captcha_invalid: "We could not confirm you are human. Reload the page and try again.",
