...
export function DeviceControlsRail(props: {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto flex shrink-0 flex-col items-center gap-1 overflow-y-auto rounded-full border border-border/50 bg-background/80 p-1 shadow-sm [scrollbar-width:none]">
        <RailButton
