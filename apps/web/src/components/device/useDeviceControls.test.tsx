import { EnvironmentId, type DeviceDetail, type DeviceSummary } from "@spiritdevs/contracts";
import type { DeviceHubAccess } from "@spiritdevs/client-runtime/device/hub-access";
