...
import type { PhoneViewer } from "@spiritdevs/client-runtime/device/phone-viewer";
import type {
  DeviceAccessorySource,
  DeviceModelSource,
} from "@spiritdevs/client-runtime/device/model";
import type { DeviceShapeProfile } from "@spiritdevs/client-runtime/device/shape-profile";
...
const loadPhoneViewer = () => import("@spiritdevs/client-runtime/device/phone-viewer");
