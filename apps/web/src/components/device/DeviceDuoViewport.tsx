...
import type { DuoViewer } from "@spiritdevs/client-runtime/device/duo-viewer";
import type { DeviceModelSource } from "@spiritdevs/client-runtime/device/model";
import { createPhoneInteraction } from "@spiritdevs/client-runtime/device/phone-interaction";
import { createCanvasFrameSink } from "@spiritdevs/client-runtime/device/frame";
import type {
  DeviceScreenSize,
  DeviceStreamClient,
} from "@spiritdevs/client-runtime/device/stream";
import { createDuoPinch } from "@spiritdevs/client-runtime/device/duo-control";
import { bindPhoneTrackpad } from "./phoneTrackpad";

const loadDuoViewer = () => import("@spiritdevs/client-runtime/device/duo-viewer");
