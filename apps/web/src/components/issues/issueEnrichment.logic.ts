...
export const ISSUE_INVESTIGATE_BLOCK_REASONS: Readonly<Record<IssueInvestigateBlock, string>> = {
  ...
  deleted: "This task is deleted. Restore it to investigate.",
  "no-project": "Assign this task to a project with a connected workspace before investigating it.",
  "rootless-project":
    "This project has no directory yet. Attach one and the investigation can read it.",
  "in-flight": "An investigation is already running on this task.",
};
