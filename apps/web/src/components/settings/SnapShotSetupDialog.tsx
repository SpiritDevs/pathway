...
const GNOME_ACCESS_COPY = {
  "not-installed": {
    ...
    description:
      "The Pathway GNOME extension lets you capture other windows and bring them into your draft. Sign out once after installing.",
  },
  "restart-required": {
  ...
  disabled: {
    ...
    description: "Enable Pathway SnapShots to start capturing windows.",
  },
  enabled: {
  ...
  error: {
    ...
    description: "Check Pathway SnapShots in GNOME Extensions, then try again.",
  },
};
              ...
              : {
                  title:
                    helper?.status === "update-required"
                      ...
                      : "Allow snapshots",
                  description:
                    "Pathway's capture helper lets you capture other apps and return to your draft. It's included with Pathway.",
                }
          : backend === "niri"
            ? {
                title: "Capture is ready",
      ...
      <DialogPopup className="max-w-xl" showCloseButton={!busy}>
        ...
        <DialogPanel>
          <div className="space-y-4 text-sm">
            ...
            {error ? (
              <p role="alert" className="text-destructive">
                {macPermissions && step === "access"
                  ? "Couldn't verify capture access. Check for a macOS permission prompt, then try again. Restart Pathway if you just allowed Screen Recording."
              ...
              <details className="text-xs text-muted-foreground">
                ...
                <div className="mt-3 space-y-3">
                  ...
                  {step === "access" && (backend === "gnome" || helperBackend) ? (
                    <p>Included with Pathway. No download needed.</p>
                  ) : null}
