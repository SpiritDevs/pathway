    ...
    <SettingsPageContainer>
      <SettingsSection title="General">
        ...
        <SettingsRow
          ...
          description="Sidebar threads with no activity for this long settle automatically. Threads on merged PRs always settle."
          resetAction={
            settings.sidebarAutoSettleAfterDays !==
            DEFAULT_UNIFIED_SETTINGS.sidebarAutoSettleAfterDays ? (
              <SettingResetButton
...
// Keep the existing route and imports compatible while storage owns this settings page.
export { StorageDashboardPanel as ArchivedThreadsPanel } from "./StorageDashboardPanel";
