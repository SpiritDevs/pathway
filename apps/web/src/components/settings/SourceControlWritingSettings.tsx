...
import type { SourceControlWritingStyleMode } from "@spiritdevs/contracts";
...
import { resolveSourceControlWriterModelSelection } from "@spiritdevs/shared/serverSettings";
