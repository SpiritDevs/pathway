...
const PIERRE_ICON_SPRITE_ID = "pathway-pierre-file-icon-sprite";

const Pathway_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="pathway-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="pathway-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="pathway-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="pathway-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="pathway-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="pathway-file-icon-pnpm" viewBox="0 0 32 32">
...
export const Pathway_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: Pathway_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "pathway-file-icon-package-json",
    "tsconfig.json": "pathway-file-icon-tsconfig",
    "agents.md": "pathway-file-icon-agents",
    "claude.md": "pathway-file-icon-claude",
    "readme.md": "pathway-file-icon-readme",
    "pnpm-lock.yaml": "pathway-file-icon-pnpm",
    "pnpm-workspace.yaml": "pathway-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(Pathway_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${Pathway_FILE_ICON_SPRITE}`;
