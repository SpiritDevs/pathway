...
export const PERSISTED_STATE_KEY = "pathway:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "pathway:renderer-state:v8",
  "pathway:renderer-state:v7",
  "pathway:renderer-state:v6",
  "pathway:renderer-state:v5",
  "pathway:renderer-state:v4",
  "pathway:renderer-state:v3",
