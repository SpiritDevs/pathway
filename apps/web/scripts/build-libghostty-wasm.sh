...
GHOSTTY_SOURCE_DIR="${GHOSTTY_SOURCE_DIR:-${HOME}/.cache/pathway/ghostty-${GHOSTTY_REVISION:0:8}}"
...
ensure_zig() {
  ...
  cache_dir="${HOME}/.cache/pathway/zig-${GHOSTTY_ZIG_VERSION}"
...
(
  ...
  # identifies its own provenance through ghostty_build_info(); the root native
