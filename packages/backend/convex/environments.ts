...
const executionEnvironmentDescriptor = v.object({
  ...
  capabilities: v.object({
    ...
    threadForceSettlement: v.optional(v.boolean()),
    threadSettleAfterCompletion: v.optional(v.boolean()),
    threadConversations: v.optional(v.boolean()),
    ...
    computerPolicy: v.optional(v.boolean()),
