...
import {
  ...
  buildRemotePathwayRunnerScript,
...
describe("ssh tunnel scripts", () => {
  ...
  it("uses the remote Pathway runner for launch and pairing scripts", () => {
    ...
    assert.include(buildRemoteLaunchScript(), "Remote Pathway server did not become ready");
    assert.include(
      buildRemoteLaunchScript({ packageSpec: "@spiritdevs/pathway@nightly" }),
    ...
    assert.include(
      buildRemotePairingScript(target, { packageSpec: "@spiritdevs/pathway@nightly" }),
      "@spiritdevs/pathway@nightly",
    );
    assert.include(
