import type { PullRequestDiffInput, PullRequestDiffResult } from "@spiritdevs/contracts";
...
>()("@spiritdevs/client-runtime/state/pullRequestDiffHttp/PullRequestDiffLoader") {}
