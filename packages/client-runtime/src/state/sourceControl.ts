...
export function createSourceControlEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    repositoryOwners: createEnvironmentRpcQueryAtomFamily(runtime, {
      label: "environment-data:source-control:repository-owners",
      tag: WS_METHODS.sourceControlListRepositoryOwners,
    }),
