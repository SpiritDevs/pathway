...
import {
  ...
  type RequestBrowserTakeoverInput,
  type RequestWorkspaceMoveInput,
  type ResolveBrowserTakeoverInput,
  ...
  type SettleAfterCompletionInput,
...
export type {
  ...
  RequestBrowserTakeoverInput,
  RequestWorkspaceMoveInput,
  ResolveBrowserTakeoverInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    setSettleAfterCompletion: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:settle-after-completion",
      execute: (input: SettleAfterCompletionInput) => setSettleAfterCompletion(input),
      scheduler,
      concurrency,
    }),
    ...
    // Browser takeover: every state transition the user can trigger. The
    // projection is the only source of truth for what the takeover is doing,
    // so these commands report nothing back beyond dispatch success.
    requestBrowserTakeover: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:browser-takeover-request",
      execute: (input: RequestBrowserTakeoverInput) => requestBrowserTakeover(input),
      scheduler,
      concurrency,
    }),
    requestWorkspaceMove: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:workspace-move-request",
      execute: (input: RequestWorkspaceMoveInput) => requestWorkspaceMove(input),
      scheduler,
      concurrency,
    }),
    proceedBrowserTakeover: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:browser-takeover-proceed",
      execute: (input: ResolveBrowserTakeoverInput) => proceedBrowserTakeover(input),
      scheduler,
      concurrency,
    }),
    releaseBrowserTakeover: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:browser-takeover-release",
      execute: (input: ResolveBrowserTakeoverInput) => releaseBrowserTakeover(input),
      scheduler,
      concurrency,
    }),
    ...
    editAndRestartMessage: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:edit-and-restart-message",
      execute: (input: EditAndRestartMessageInput) => editAndRestartMessage(input),
      scheduler,
      concurrency,
    }),
