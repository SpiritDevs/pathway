...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    editTurn: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:edit-turn",
      execute: (input: EditThreadTurnInput) => editThreadTurn(input),
      scheduler,
      concurrency,
    }),
