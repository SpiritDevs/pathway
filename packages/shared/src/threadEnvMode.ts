import type { ThreadEnvMode } from "@spiritdevs/contracts";

/**
 * Canonical priority order for a project's default thread env mode:
 * per-project setting > checked-in pathway.json > global server setting.
 *
 ...
 * source that outranks pathway.json decided, or the file read settled. While
