 ...
 * default lives here.
 */
export const DEFAULT_HOSTED_APP_URL = "https://app.pathwayos.dev";
export const NIGHTLY_HOSTED_APP_URL = "https://app.pathwayos.dev";
...
export function checkConnectAuthCode(
  ...
  if (parsed === null) {
    return "That does not look like a Pathway Connect code. Copy the full code.";
  }
