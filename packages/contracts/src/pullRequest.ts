...
> = {
  ...
  bitbucket: {
    missing:
      "Bitbucket needs API credentials on the server. Set PATHWAY_BITBUCKET_EMAIL and PATHWAY_BITBUCKET_API_TOKEN, or PATHWAY_BITBUCKET_ACCESS_TOKEN.",
    unauthenticated:
      "Bitbucket rejected the configured credentials. Check PATHWAY_BITBUCKET_EMAIL and PATHWAY_BITBUCKET_API_TOKEN.",
  },
};
