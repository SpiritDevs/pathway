...
import {
  PathwayProjectFile,
  type PathwayProjectFile as PathwayProjectFileType,
} from "./pathwayProjectFile.ts";

const decode = Schema.decodeUnknownSync(PathwayProjectFile as never) as (
  input: unknown,
) => PathwayProjectFileType;

describe("PathwayProjectFile", () => {
  it("decodes a full project file", () => {
    const decoded = decode({
      $schema: "https://pathway.codes/schema/pathway.json",
