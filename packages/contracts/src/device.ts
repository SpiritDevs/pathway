 ...
 *
 * Devices live on a local or SSH host. Host identity accompanies every device
 * and session so matching simulator identifiers on different hosts stay distinct.
 *
 * @module Device
 */
...
/** The environment server machine, always present alongside configured SSH hosts. */
