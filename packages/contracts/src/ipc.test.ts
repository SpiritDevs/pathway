...
const decodePopupRequest = Schema.decodeUnknownSync(DesktopPreviewPopupRequestSchema);
const decodeAdoptPopup = Schema.decodeUnknownSync(DesktopPreviewAdoptPopupInputSchema);
const decodePresentation = Schema.decodeUnknownSync(DesktopPreviewPresentNativeTabInputSchema);
