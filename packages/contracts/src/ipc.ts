...
export interface DesktopPreviewWebviewConfig {
  /** `persist:pathway-preview` (or whatever the desktop chose). */
  partition: string;
  /**
...
export const DesktopPreviewPopupClosedEventSchema = Schema.Struct({
  runtimeTabId: DesktopPreviewTabIdSchema,
});
export type DesktopPreviewPopupClosedEvent = typeof DesktopPreviewPopupClosedEventSchema.Type;
...
export interface DesktopPreviewBridge {
  ...
  onPopupClosed: (listener: (event: DesktopPreviewPopupClosedEvent) => void) => () => void;
