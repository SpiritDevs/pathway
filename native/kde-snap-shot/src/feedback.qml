...
Item {
    ...
    // A cached, bounded PNG is shared by each output. Nothing repaints while waiting for Pathway.
    Image {
        id: snapshot
        visible: false
    ...
    DBusCall {
        id: next
        service: root.bus
        path: "/com/spiritdevs/KdeCapture/Feedback"
        dbusInterface: "com.spiritdevs.KdeCapture.Feedback"
        method: "Next"
