...
// The production error type lives in PathwayHelperProtocol.swift; this small fixture
...
let appURL = URL(fileURLWithPath: "/Applications/Pathway Test.app", isDirectory: true)
let otherURL = URL(fileURLWithPath: "/tmp/Pathway Test.app", isDirectory: true)
var checks = 0
